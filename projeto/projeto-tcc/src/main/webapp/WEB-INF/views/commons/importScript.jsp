...
<script type="text/javascript"
	src="<c:url value="/resources/script/SimplejQueryDropdowns/js/jquery.dropdownPlain.js"/>"></script>
<link rel="stylesheet"
	href='<c:url value="/resources/script/SimplejQueryDropdowns/css/style.css"/>' />
