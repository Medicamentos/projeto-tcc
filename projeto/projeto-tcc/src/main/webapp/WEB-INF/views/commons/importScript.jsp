...
<script type="text/javascript" src='<c:url value="/resources/script/bibliotecas/jquery-2.1.1.min.js"/>'></script>
<script type="text/javascript" src='<c:url value="/resources/script/bibliotecas/jquery.livequery.js"/>'></script>
...
<script type="text/javascript" src="<c:url value="/resources/script/bibliotecas/tableSorter/jquery.tablesorter.js"/>"></script>
...
<link rel="stylesheet" href='<c:url value="/resources/script/bibliotecas/tableSorter/themes/blue/style.css"/>' />
<meta http-equiv="Content-Type" content="text/html; charset=ISO-8859-1">
<title>Medicamentos e Insumos</title>